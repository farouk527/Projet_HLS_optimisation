...
extern "C" void matrixmul_accel_core(int*, int*);
extern "C" void apatb_matrixmul_accel_core_hw(volatile void * __xlx_apatb_param_input, volatile void * __xlx_apatb_param_output) {
  ...
  for (int j = 0, e = 2048; j != e; ++j) {
    __xlx_input__tmp_vec.push_back(((int*)__xlx_apatb_param_input)[j]);
  }
  int __xlx_size_param_input = 2048;
  ...
  int __xlx_size_param_output = 1024;
  ...
  // DUT call
  matrixmul_accel_core(__xlx_input__input_buffer, __xlx_output__input_buffer);
