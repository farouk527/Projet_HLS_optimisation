...
set id 1
set name matrixmul_accel_core_fadd_32ns_32ns_32_5_full_dsp_1
...
set id 3
set name matrixmul_accel_core_fmul_32ns_32ns_32_4_max_dsp_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename res \
    op interface \
    ports { res_address0 { O 10 vector } res_ce0 { O 1 bit } res_we0 { O 1 bit } res_d0 { O 32 vector } } \
} "
} else {
